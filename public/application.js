...
var onSignUp = function onSignUp(event) {
  ...
  api.signUp(data).then(ui.signUpSuccess).then(function () {
    $('#user-signup input[type="email"]').val('');
  }).then(function () {
    $('#user-signup input[type="password"]').val('');
...
var onSignIn = function onSignIn(event) {
  ...
  api.signIn(data).then(ui.signInSuccess).then(function () {
    $('#user-signin input[type="email"]').val('');
  }) // WRAP IT IN AN ANONYMOUS FUNCTION!!
  .then(function () {
    $('#user-signin input[type="password"]').val('');
  }).then(function () {
    $('#before-signinauth').hide();
  }).then(function () {
    $('#after-signinauth').show();
...
var onCreateDowntime = function onCreateDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createDowntime(data).then(ui.createDowntimeSuccess).then(function () {
    $('#create-downtime input[type="date"]').val('');
  }).then(function () {
    $('#create-downtime input[type="datetime-local"]').val('');
  }).then(function () {
    $('#create-downtime input[type="text"]').val('');
...
var onGetMyDowntime = function onGetMyDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getMyDowntime(data).then(ui.getMyDowntimeSuccess).then(function () {
    $('#get-downtime input[type="text"]').val('');
...
var onUpdateDowntime = function onUpdateDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.updateDowntime(data).then(ui.updateDowntimeSuccess).then(function () {
    $('#update-downtime input[type="date"]').val('');
  }).then(function () {
    $('#update-downtime input[type="datetime-local"]').val('');
  }).then(function () {
    $('#update-downtime input[type="text"]').val('');
...
var onDeleteDowntime = function onDeleteDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.deleteInstance(data).then(ui.deleteDowntimeSuccess).then(function () {
    $('#delete-downtime input[type="text"]').val('');
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      Duration (Minutes): "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.duration : stack1), depth0))
    + "\n";
},"15":function(container,depth0,helpers,partials,data) {
    return "      No duration recorded.  You should update this.\n";
  ...
  return "\n<!--data.downtime_instance.id\n    data.downtime_instance.activity\n    data.downtime_instance.date\n    data.downtime_instance.time\n-->\n  <!--USE HANDLEBARS FOR LAYOUT-where jQuery, Javascript, etc. -->\n  <!-- Use it to make a truly single single-page app, hide and format!!-->\n  <!-- Helps you do the same thing in HTML to every element via EACH -->\n <!-- Developers, why are we using data-id and not just id? -->\n<div data-id=\""
    ...
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.id : stack1), depth0))
    + "</h3>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.date : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "  </p>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.time : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "  </p>\n  <p>\n"
    ...
    + "  </p>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.duration : stack1),{"name":"if","hash":{},"fn":container.program(13, data, 0),"inverse":container.program(15, data, 0),"data":data})) != null ? stack1 : "")
    + "  </p>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div data-id=\""
    ...
    + "  </p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.duration : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n\n";
  ...
  return "      <p>Duration (Minutes): "
    ...
    return "      <p>No duration recorded.  You should update this.</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.downtime_instances : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = __webpack_require__.p + "52cbd33814b5dbce7ed9cbcf675b1a78.jpg";
